...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate CP rank sweep config")
    parser.add_argument(
        "--output",
        type=str,
        default="config_cp_rank_sweep.json",
    ...
    print(
        ...
        f"({len(RANKS_20)} ranks x 2 conditions, method=CP)."
    )
